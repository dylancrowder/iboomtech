...
export const useImageForProduct = (model: string, color: string) => {
  const getImage = () => {
    const imageMap: { [key: string]: any } = {
      ...
      "iPhone 16e-Blanco": iphone_16e_blanco,
      "iPhone 16e-Negro": iphone_16e_negro,
      //iphone 16pro
    ...
    const imageKey = `${model}-${color}`;
    return imageMap[imageKey] || "/images/default.jpg"; // Devolver una imagen predeterminada si no se encuentra la clave
  };
